  ...
  <div class="w-full flex justify-center mt-8">
    ...
    >
      ...
      >
        ...
        <div
          @click="maybeWatch(video)"
          :class="[
            isLocale(video.fields.language)
              ? 'cursor-pointer hover:bg-near-yellow-light'
              : '',
        ...
        >
          <div class="flex-1 truncate">
            <div class="flex items-center space-x-3">
              ...
              <span
                v-for="tag in video.fields.content_tags"
                :key="tag"
                class="
                  flex-shrink-0
                  inline-block
        ...
        <span
          :class="[
            isLocale(video.fields.language)
              ? 'bg-near-green-medium'
              : 'bg-gray-200',
            'absolute top-0 right-0 m-2 h-2 w-2 flex-shrink-0 inline-block rounded-full',
          ]"
          aria-hidden="true"
        />
      </li>
