  ...
  <div v-if="summaryStatus === 'ready'" class="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 border-b border-gray-light">
    <div class="grid grid-cols-2 gap-8 lg:grid-cols-5">
      <div class="text-gray-400 flex flex-col justify-center">
        <p class="mx-auto text-6xl font-extralight">{{ summary.authors.length }}</p>
        <p class="mx-auto text-base text-gray-500">contributors</p>
      </div>
      <div class="text-gray-400 flex flex-col justify-center">
        <p class="mx-auto text-6xl font-extralight">{{ summary.contributions }}</p>
        <p class="mx-auto text-base text-gray-500">videos</p>
      </div>
      <div class="text-gray-400 flex flex-col justify-center">
        <p class="mx-auto text-6xl font-extralight">{{ toHours(summary.duration) }}</p>
        <p class="mx-auto text-base text-gray-500">hours of content</p>
      </div>
      <div class="text-gray-400 flex flex-col justify-center">
        <p class="mx-auto text-6xl font-extralight">{{ summary.language_content.length }}</p>
